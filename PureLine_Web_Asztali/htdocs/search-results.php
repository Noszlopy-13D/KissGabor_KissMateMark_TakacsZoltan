...
// Keresési kulcsszó beállítása és SQL injekció elleni védelem
$search = isset($_POST['search']) ? $conn->real_escape_string(trim($_POST['search'])) : '';

// Alapértelmezett lekérdezés feltételek nélkül
$query = "SELECT * FROM products";
$conditions = [];

// Csak a `name` mezőre keresünk
if ($search) {
    $conditions[] = "name LIKE '%$search%'";
}

// Szűrők hozzáadása (nem, ár)
...
// Ha vannak feltételek, hozzáadjuk őket a lekérdezéshez
if (!empty($conditions)) {
...
// Összes termék számítása lapozáshoz
...
<div class="container pb-5 mb-2 mb-md-4">
                                ...
                                <ul class="widget-list widget-filter-list list-unstyled pt-1" style="max-height: 11rem;" data-simplebar data-simplebar-auto-hide="false">
                                    <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label widget-filter-item-text">Minden</label>
                                        </div>
                                    </li>
                                    <li class="widget-filter-item d-flex justify-content-between align-items-center mb-1">
                                        <div class="form-check">
    ...
    <div class="row mx-n2">
        ...
        <?php else: ?>
            <!-- Nincs találat üzenet szép dizájnnal -->
            <div class="col-12 text-center my-5">
                <div class="alert alert-info py-5" role="alert" style="background-color: #f0f8ff; color: #333; border-radius: 8px;">
                    <h3 class="mb-3">Nincs találat</h3>
                    <p>Nem találtunk a keresésnek megfelelő termékeket. Próbálkozz másik kulcsszóval vagy módosítsd a szűrőket!</p>
                    <a href="shop.php" class="btn btn-primary mt-4">Vissza a boltba</a>
                </div>
            </div>
        <?php endif; ?>
    </div>
